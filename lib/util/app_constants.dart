...
class AppConstants {
  static const int customerType = 3;
  static const String appName = 'Seven Taxi';
  ...
  static List<OnBoardingModel> onBoardPagerData = [
    OnBoardingModel(
        title: 'on_boarding_1_title'.tr, image: 'assets/image/passenger.png'),
    OnBoardingModel(
        title: 'on_boarding_2_title'.tr,
        image: 'assets/image/mobile_tracker.png'),
    OnBoardingModel(
        title: 'on_boarding_3_title'.tr, image: 'assets/image/car_one.png'),
    // OnBoardingModel(
