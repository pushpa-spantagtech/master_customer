            ...
            child: Center(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                Padding(
                  ...
                  child: SizedBox(
                      width: Dimensions.couponIconSize,
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ' ${widget.coupon.amountType == 'percentage' ? '${double.parse(widget.coupon.coupon!).toStringAsFixed(0)} %' : PriceConverter.convertPrice(double.parse(widget.coupon.coupon!))} OFF',
