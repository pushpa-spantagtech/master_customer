...
class _RiderDetailsWidgetState extends State<RiderDetailsWidget> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => Get.off(
          () => BiddingListScreen(tripId: widget.tripId, fromList: true)),
            ...
            child: Column(children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ClipRRect(
                  ...
                  child: ImageWidget(
                    ...
                    width: 50,
                    image:
                        '${Get.find<ConfigController>().config!.imageBaseUrl!.profileImageDriver}/${widget.bidding.driver!.profileImage}',
                  ),
                ),
                    ...
                    child: Column(
                      ...
                      Text.rich(TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text:
                                '${widget.bidding.driver?.firstName} ${widget.bidding.driver?.lastName}',
                      ...
                      Row(
                          ...
                          children: [
                            Text.rich(TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  text: widget.bidding.driver?.vehicle?.model
                                          ?.name ??
                                      '',
                                  style: textMedium.copyWith(
                                    color: Theme.of(context).primaryColorDark,
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            if (rideController.remainingDistanceModel != null &&
                                rideController
              ...
              Row(children: [
                Expanded(
                  ...
                  boldText: false,
                  onPressed: () {
                    rideController.ignoreBidding(
                        widget.bidding.id!, widget.tripId);
                  },
                )),
                ...
                Expanded(
                  ...
                  onPressed: () async {
                    rideController.tripAcceptOrRejected(
                        widget.bidding.tripRequestsId!,
                        'accepted',
                        widget.bidding.driver!.id!);
                  },
                )),
              ])
            ]),
