                        ...
                        children: [
                          SizedBox(
                            ...
                            child: ClipRRect(
                              ...
                              child: ImageWidget(
                                  image: offerModel.image!, fit: BoxFit.cover),
                            ),
                          ),
                          const SizedBox(
                          ...
                          Container(
                            ...
                            child: Column(
                                ...
                                children: [
                                          ...
                                          children: [
                                              ...
                                              Expanded(
                                                child: RichText(
                                                    text: TextSpan(
                                                        text:
                                                            '${'this_offer_available_only_in'.tr} ',
                                                        style: textRegular.copyWith(
                                                            fontSize: Dimensions
                                                                .fontSizeSmall,
                                                            color: Theme.of(
                                  ...
                                  const SizedBox(
                                      height: Dimensions.paddingSizeExtraSmall),
                                  offerModel.customerLevelDiscount!
                                          .contains('all')
                                      ? const SizedBox()
                                      : Row(
                                          crossAxisAlignment:
                                          ...
                                          children: [
                                              ...
                                              Expanded(
                                                child: RichText(
                                                    text: TextSpan(
                                                        text:
                                                            '${'to_get_this_offer_user_must_be'.tr} ',
                                                        style: textRegular.copyWith(
                                                            fontSize: Dimensions
                                                                .fontSizeSmall,
                                                            color: Theme.of(
                                  ...
                                  Row(children: [
                                    ...
                                    Expanded(
                                      child: RichText(
                                          text: TextSpan(
                                              text:
                                                  '${'one_user_can_use_it_maximum'.tr} ',
                                              style: textRegular.copyWith(
                                                  fontSize:
                                    ...
                                    Expanded(
                                      child: RichText(
                                          text: TextSpan(
                                            ...
                                            TextSpan(
                                              text:
                                                  '${Get.find<ConfigController>().config!.currencySymbol}${offerModel.minTripAmount}',
                                              style: textSemiBold.copyWith(
                                                  fontSize:
                                                      Dimensions.fontSizeSmall),
                                            )
                                          ...
                                          Expanded(
                                            child: RichText(
                                                text: TextSpan(
                                                  ...
                                                  TextSpan(
                                                    text:
                                                        '${Get.find<ConfigController>().config!.currencySymbol}${offerModel.maxDiscountAmount}',
                                                    style:
