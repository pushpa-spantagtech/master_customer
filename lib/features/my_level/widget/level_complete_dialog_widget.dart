            ...
            child: SizedBox(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                if (rewardType == 'wallet' ||
                  ...
                  Text(
                    '${'you_have_earned'.tr} '
                    '${rewardType == 'wallet' ? PriceConverter.convertPrice(double.parse(reward)) : '${double.parse(reward).toInt()} ${'points'.tr}'}',
                    style: textBold.copyWith(
                        color: Theme.of(context).textTheme.bodyLarge!.color),
                  ),
                ...
                ButtonWidget(
                  ...
                  margin: const EdgeInsets.symmetric(
                      vertical: Dimensions.paddingSizeSmall, horizontal: 40),
                ),
              ]),
            ),
          ),
