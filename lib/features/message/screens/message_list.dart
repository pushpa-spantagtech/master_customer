        ...
        body: GetBuilder<MessageController>(builder: (messageController) {
          return Padding(
              padding: const EdgeInsets.symmetric(
                  horizontal: Dimensions.paddingSizeSixteen),
                    ...
                    ? messageController.channelModel!.data!.isNotEmpty
                        ? Expanded(
                            ...
                            child: PaginatedListWidget(
                              ...
                              totalSize:
                                  messageController.channelModel!.totalSize,
                              offset: messageController.channelModel != null &&
                                      messageController.channelModel!.offset !=
                                          null
                        ...
                        : const Expanded(
                            child: NoDataWidget(title: 'no_chat_found'))
