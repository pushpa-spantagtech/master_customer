...
class _TipsWidgetState extends State<TipsWidget> {
  ...
  void initState() {
    if (Get.find<PaymentController>().tipAmount != '0') {
      amountController.text = PriceConverter.convertPrice(
          double.parse(Get.find<PaymentController>().tipAmount));
    }
    super.initState();
  }
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (amountContext, index) {
                      return GestureDetector(
                        onTap: () {
                          amountController.text = PriceConverter.convertPrice(
                              _suggestedAmount[index].toDouble());
                          selectedIndex = index;
                          setState(() {});
                        },
                        child: Padding(
