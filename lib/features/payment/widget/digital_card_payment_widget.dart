  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GetBuilder<PaymentController>(builder: (paymentController) {
        return InkWell(
          onTap: () => Get.find<PaymentController>()
              .setDigitalPaymentType(index, digitalPaymentModel.gateway ?? ''),
          child: Padding(
            padding:
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(digitalPaymentModel.gatewayTitle ?? '',
                    ...
                    SizedBox(
                        ...
                        child: ImageWidget(
                            image:
                                '${AppConstants.baseUrl}/storage/app/public/payment_modules/gateway_image/${digitalPaymentModel.gatewayImage ?? ''}'))
                  ],
                ),
              ),
            ),
