...
class _ApplyCouponState extends State<ApplyCoupon> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CouponController>(builder: (couponController) {
      String text =
          Get.find<RideController>().finalFare?.coupon?.couponCode ?? '';
      return (Get.find<RideController>().finalFare?.couponAmount != null &&
              Get.find<RideController>().finalFare!.couponAmount! > 0)
          ? Container(
              height: 50,
                      ...
                      children: [
                        ...
                        Text(
                          Get.find<RideController>()
                              ...
                              : '( - ${PriceConverter.convertPrice(Get.find<RideController>().finalFare!.couponAmount!.toDouble())} ${'off'.tr} )',
                          style: textRegular.copyWith(
                              fontSize: Dimensions.fontSizeDefault,
