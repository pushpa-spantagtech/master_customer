...
class _PointToWalletMoneyWidgetState extends State<PointToWalletMoneyWidget> {
  ...
  @override
  void initState() {
    amountController.text = Get.find<ProfileController>()
        .profileModel!
        .data!
        .loyaltyPoints!
        .toString();
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                '${PriceConverter.convertPrice(_convertDouble(amountController.text) / Get.find<ConfigController>().config!.conversionRate!)}',
                style: textRegular,
                textAlign: TextAlign.center,
              ),
              Container(
                          ...
                          if (point.isEmpty) {
                            ...
                            walletController.convertPoint(point).then((value) {
                              if (value.statusCode == 200) {
                                Get.back();
                                showCustomSnackBar(
                                    'point_converted_successfully'.tr,
                                    isError: false);
